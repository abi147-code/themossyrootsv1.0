...
export default function LoginClient({ fontClassName = '' }: LoginClientProps) {
      ...
      <main className="login-main">
        <motion.div {...fadeIn} className="login-card">
          <div className="space-y-3 text-center">
            <p className="login-kicker">The Mossy Roots</p>
            <h1 className="login-h1">Welcome back</h1>
            <p className="login-lede">Log back into your TMR workspace.</p>
          </div>
