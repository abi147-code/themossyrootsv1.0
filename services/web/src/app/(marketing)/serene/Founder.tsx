      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
        ...
        >
          <div className="space-y-4">
            <h2 className="text-xs uppercase tracking-[0.3em] text-emerald-400 font-medium opacity-70">Founder</h2>
            <p className="text-3xl md:text-4xl font-serif text-white leading-snug">
              The Mossy Roots is powered by the work of Abishek Elangeswaran.
            </p>
          </div>
        ...
        >
          ...
          <div className="absolute bottom-10 left-10 right-10 p-6 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl">
            <div className="text-[10px] uppercase tracking-[0.2em] text-emerald-400/80 mb-1">Portfolio</div>
            <div className="text-sm font-serif italic text-white/90">Work that blends strategy, automation, and design.</div>
          </div>
