...
const seoTitle = 'Welcome to The Mossy Roots – Invoice Marketing & CRM (Legacy)';
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://themossyroots.com/legacy-home',
  },
  openGraph: {
    title: seoTitle,
    description: seoDescription,
    url: 'https://themossyroots.com/legacy-home',
