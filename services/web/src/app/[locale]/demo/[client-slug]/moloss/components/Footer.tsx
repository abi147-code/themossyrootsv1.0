    ...
    <footer className="bg-moloss-black text-moloss-white py-12 md:py-16 px-6 md:px-12">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
        <div className="col-span-1 md:col-span-1 flex flex-col items-start">
          <Link href={basePath} className="font-display font-black text-4xl tracking-tighter uppercase mb-4 text-moloss-ice">
            Moloss
          </Link>
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <ul className="space-y-3">
            <li><Link href={`${basePath}/#menu`} className="text-moloss-white/80 hover:text-moloss-ice transition-colors font-medium text-sm">{t('nav.menu')}</Link></li>
            <li><Link href={`${basePath}/#story`} className="text-moloss-white/80 hover:text-moloss-ice transition-colors font-medium text-sm">{t('nav.story')}</Link></li>
            <li><Link href={`${basePath}/#locations`} className="text-moloss-white/80 hover:text-moloss-ice transition-colors font-medium text-sm">{t('nav.locations')}</Link></li>
            <li><Link href={blogPath} className="text-moloss-white/80 hover:text-moloss-ice transition-colors font-medium text-sm">{t('nav.blog')}</Link></li>
          </ul>
        </div>
