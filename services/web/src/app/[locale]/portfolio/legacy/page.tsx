...
export const metadata: Metadata = {
  title: 'Portfolio – The Mossy Roots (Legacy)',
  description:
  ...
  alternates: {
    canonical: 'https://themossyroots.com/portfolio/legacy',
  },
  openGraph: {
    ...
    url: 'https://themossyroots.com/portfolio/legacy',
...
export default function PortfolioLegacyPage() {
