...
const LOCAL_IMAGE_FILES = [
  'abishek-cBbtRaOBSPA-unsplash.jpg',
  'abishek-dtA-Rll5RvE-unsplash.jpg',
  'abishek-IBbHqqDI-mw-unsplash.jpg',
  'abishek-JblqZzRbYIU-unsplash.jpg',
  'abishek-N1SR9piSgOI-unsplash.jpg',
  'abishek-no_X0h-vqTI-unsplash.jpg',
  'abishek-qTERBkAM63Y-unsplash.jpg',
  'abishek-rc8jC4GYaBs-unsplash.jpg',
  'abishek-srgtpAXe7Zo-unsplash.jpg',
  'abishek-ZfoC5fNZeeI-unsplash.jpg',
  'betweenseawalls.JPG',
  'IMG_0042.jpeg',
  'IMG_0119.jpg',
  'IMG_0200.jpg',
...
const DEFAULT_IMAGES: ImageItem[] = LOCAL_IMAGE_FILES.map((file) => ({
  src: `/pictures/${file}`,
  alt: humanizeFilename(file) || 'Portfolio image'
}));
...
export default function DomeGallery({
  ...
  const applyTransform = useCallback((xDeg: number, yDeg: number) => {
    pendingRotationRef.current = { x: xDeg, y: yDeg };
  ...
  useGesture(
    {
      ...
      onDrag: ({ event, last, velocity = [0, 0], direction = [0, 0], movement }) => {
        ...
        if (!movedRef.current) {
          ...
          if (dist2 > 6) movedRef.current = true;
        }
